...
print '### creating singal model WW ###'
print signalmodelcommand + '--cat WW'
os.system(signalmodelcommand + '--cat WW')
print '### creating singal model WZ ###'
print signalmodelcommand + '--cat WZ'
os.system(signalmodelcommand + '--cat WZ')

print '### creating workspace for text2workspace.py ###'
print 'python buildWorkspace_WWWZ.py --config=config_ATGC2 -o %s'%datacard
os.system('python buildWorkspace_WWWZ.py --config=config_ATGC2 -o %s'%datacard)

print '### creating final workspace ###'
print 'text2workspace.py %s -o %s -P %s --PO channels=%s --PO %s --PO %s --PO %s --PO %s'%(datacard,wsout,model,channels,pois,r_cwww,r_ccw,r_cb)
os.system('text2workspace.py %s -o %s -P %s --PO channels=%s --PO %s --PO %s --PO %s --PO %s'%(datacard,wsout,model,channels,pois,r_cwww,r_ccw,r_cb))
