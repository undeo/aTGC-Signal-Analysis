...
void atgcplotLimit_ccw_cb()
{
  ...
  //fnames.push_back("higgsCombine2Par_ccw0_cb0_exp_no_uncert.MultiDimFit.mH120.root");
  //fnames.push_back("higgsCombine2Par_ccw0_cb0_obs_no_uncert.MultiDimFit.mH120.root");
