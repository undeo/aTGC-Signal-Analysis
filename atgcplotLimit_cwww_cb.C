...
void atgcplotLimit_cwww_cb()
{
  ...
  //fnames.push_back("higgsCombine2Par_cwww0_cb0_exp_nouncert.MultiDimFit.mH120.root");
  //fnames.push_back("higgsCombine2Par_cwww0_cb0_obs_nouncert.MultiDimFit.mH120.root");
